 ...
 // height: viewPortHeight / 11,
  ...
  render() {
    ...
    // alignItems: 'center'
      ...
      return (
        <TouchableOpacity
        onPress={() => this.props.navigation.navigate('PushToEarnAddFriendsButtons') }
          activeOpacity={0.5}
          style={{
            width: 266,
            height: 57,
...
export default connect(mapStateToProps, mapDispatchToProps)(ButtonFriends);